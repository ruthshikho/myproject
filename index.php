...
<div class="container-fluid">
	...
	<div class="span2">
          <div class="well sidebar-nav">
			...
			<li><a href="customer.php"><i class="icon-group icon-2x"></i> Customers</a> 
			<br><br><br><br><br><br>		
			<li>
			 <div class="hero-unit-clock">
		
			<form name="clock">
			<font color="green">Time: <br></font>&nbsp;<input style="width:150px;" type="submit" class="trans" name="face" value="">
			</form>
			  </div>
			  </li>
				</ul>                               
	...
	<div class="contentheader">
			...
			<font style=" font:bold 45px 'Aleo';  color:red;"><center>Jas Hardware</center></font>
<div id="mainmain">
